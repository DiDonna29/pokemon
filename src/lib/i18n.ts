...
export const translations = {
  en: {
    ...
    hint_types: "Types: ",
    reveal_name: "Reveal Pokemon",
    revealed_msg: "The Pokemon was ",
    developed_by: "Developed by",
    rights_reserved: "All rights reserved.",
    google_ai_notice: "AI features powered by Google Gemini & Genkit.",
    portfolio: "Portfolio",
    hp: "HP",
    attack: "Attack",
    defense: "Defense",
  ...
  es: {
    ...
    hint_types: "Tipos: ",
    reveal_name: "Revelar Pokémon",
    revealed_msg: "El Pokémon era ",
    developed_by: "Desarrollado por",
    rights_reserved: "Todos los derechos reservados.",
    google_ai_notice: "Funcionalidades de IA potenciadas por Google Gemini & Genkit.",
