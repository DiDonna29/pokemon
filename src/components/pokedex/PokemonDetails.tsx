          ...
          {pokemon && (
            ...
            >
              ...
              <div className="flex-1 order-2 md:order-1 bg-card flex flex-col h-full overflow-hidden">
                {/* Fixed Top Bar in the info section for Desktop, scrolls with content in mobile */}
                <div className="p-6 md:p-8 lg:p-12 pb-0">
                  <Button 
                    onClick={onClose}
                    className="glass h-10 md:h-12 px-5 md:px-8 rounded-2xl flex items-center gap-2 border-foreground/10 hover:bg-primary/20 hover:text-foreground text-foreground transition-all group mb-6 md:mb-8"
                  >
                ...
                <div className="flex-1 overflow-y-auto px-6 md:px-8 lg:px-12 pb-12 scrollbar-thin scrollbar-thumb-foreground/10">
                  <div className="space-y-8 md:space-y-12">
                    <header className="space-y-4">
                      ...
                      <DialogTitle className="text-4xl md:text-5xl lg:text-7xl font-headline font-black capitalize tracking-tighter leading-tight">
                        {pokemon.name}
                      </DialogTitle>
                      <div className="flex flex-wrap gap-2 md:gap-3">
                        {pokemon.types.map(typeInfo => (
                          <Badge 
                            ...
                            className={cn(
                              "px-6 md:px-8 py-1.5 md:py-2.5 rounded-full text-white font-black uppercase text-[10px] md:text-xs tracking-widest border-none shadow-lg",
                    ...
                    <Tabs defaultValue="about" className="w-full">
                      ...
                      <TabsContent value="about" className="space-y-8 md:space-y-10 outline-none">
                        <div className="relative">
                          ...
                          <p className="text-muted-foreground leading-relaxed text-base md:text-lg lg:text-xl font-medium pl-2 italic">
                            "{flavorText}"
                          </p>
                        </div>
                        
                        <div className="grid grid-cols-2 gap-4 md:gap-6">
                          <div className="glass rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-8 lg:p-10 flex flex-col items-center gap-3 md:gap-5 border-foreground/5 group hover:border-primary/20 transition-all">
                            <div className="w-10 h-10 md:w-14 md:h-14 rounded-2xl bg-blue-500/10 flex items-center justify-center text-blue-500 group-hover:scale-110 transition-transform">
                              <Ruler className="w-5 h-5 md:w-7 md:h-7" />
                            </div>
                            <div className="text-center">
                              <div className="font-headline text-2xl md:text-3xl lg:text-4xl font-black">{pokemon.height / 10}m</div>
                          ...
                          <div className="glass rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-8 lg:p-10 flex flex-col items-center gap-3 md:gap-5 border-foreground/5 group hover:border-orange-500/20 transition-all">
                            <div className="w-10 h-10 md:w-14 md:h-14 rounded-2xl bg-orange-500/10 flex items-center justify-center text-orange-500 group-hover:scale-110 transition-transform">
                              <Weight className="w-5 h-5 md:w-7 md:h-7" />
                            </div>
                            <div className="text-center">
                              <div className="font-headline text-2xl md:text-3xl lg:text-4xl font-black">{pokemon.weight / 10}kg</div>
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-3">
                                <div className="w-8 h-8 md:w-9 md:h-9 rounded-lg bg-foreground/5 flex items-center justify-center group-hover:text-primary transition-colors">
                            ...
                            <Progress 
                              ...
                              className="h-2 md:h-2.5 bg-foreground/5"
                            />
                          </motion.div>
                        ))}
                      </TabsContent>
              ...
              <div className={cn(
                "relative flex-1 min-h-[380px] md:min-h-0 flex flex-col items-center justify-center p-8 md:p-12 order-1 md:order-2 overflow-hidden",
                ...
                >
                  <div className="absolute inset-0 bg-white/30 blur-[100px] md:blur-[150px] rounded-full scale-125 opacity-40" />
                  {artwork && (
                    <Image 
                      src={artwork} 
                      alt={pokemon.name} 
                      width={550} 
                      height={550} 
                      className="relative z-10 drop-shadow-[0_50px_50px_rgba(0,0,0,0.5)] lg:drop-shadow-[0_80px_80px_rgba(0,0,0,0.6)] animate-float w-full max-w-[320px] md:max-w-[420px] lg:max-w-[500px] h-auto"
                      priority
                    />
                  )}
                </motion.div>
                ...
                {/* Decorative Elements */}
                <div className="absolute -bottom-16 -right-16 md:-bottom-24 md:-right-24 font-headline text-[15rem] md:text-[30rem] font-black text-white/5 select-none pointer-events-none uppercase tracking-tighter">
                  {pokemon.name.charAt(0)}
                </div>

                <div className="absolute bottom-6 left-6 md:bottom-10 md:left-10 hidden sm:flex items-center gap-3 md:gap-4 glass bg-white/10 border-none px-6 md:px-8 py-3 md:py-4 rounded-full text-white shadow-2xl backdrop-blur-3xl">
